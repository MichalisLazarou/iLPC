...
def main():
    ...
    print('Dataset: {}, iterations: {}, pca_d:{}, best samples: {}, algorithm: {}, Shots: {}, test_acc: {:.4f}, test_std: {:.4f}'.format(params.dataset, params.n_test_runs, params.d, params.best_samples, params.algorithm, params.n_shots, test_acc, test_std))
...
def ici_test(params, model, data, ici):
    ...
    with torch.no_grad():
        ...
        support_features = igf.im2features(support_xs, support_ys, model, map='mi').cpu()
        query_features = igf.im2features(query_xs, query_ys, model, map='mi').cpu()
